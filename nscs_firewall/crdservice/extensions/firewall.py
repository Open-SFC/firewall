...
class FirewallInternalDriverError(qexception.CrdException):
...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    'firewalls': {
        ...
        'config_handle_id': {'allow_post': True, 'allow_put': True,
                               'is_visible': True, 'default': None },
        'config_mode': {'allow_post': False, 'allow_put': False,
                   'is_visible': True},
    },
    'configs': {
        'config_handle_id': {'allow_post': True, 'allow_put': False,
               ...
               'is_visible': True},
        'response': {'allow_post': True, 'allow_put': True,
                 'validate': {'type:string': None},
...
class Firewall(extensions.ExtensionDescriptor):
    ...
    def get_namespace(cls):
        return "http://wiki.openstack.org/Crd/FWaaS/API_1.0"
